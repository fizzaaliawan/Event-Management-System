      ...
      <section className="relative h-96 md:h-[500px] overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-12">
          <div className="max-w-4xl">
            ...
            <h1 className="font-serif font-bold text-4xl md:text-6xl text-white mb-4 text-balance drop-shadow-lg">
              {event.name}
            </h1>
            <p className="text-xl text-white/90 max-w-2xl text-pretty drop-shadow">{event.description}</p>
          </div>
        </div>
      </section>
              ...
              <Card className="glass-card sticky top-24">
                <CardContent className="p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    ...
                    {event.price && (
                      <div className="flex items-start space-x-3">
                        <DollarSignIcon className="h-5 w-5 text-primary mt-1 flex-shrink-0" />
                        <div>
